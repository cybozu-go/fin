...
>>>>>>> 4f7a75b (feat: add checksum verification to applyDiffToRawImage)
...
func TestApplyDiffToRawImage_success(t *testing.T) {
	...
	err = applyDiffToRawImage(gotFilePath, fullReader, "", "snap20", expansionUnitSize, rawChecksumChunkSize, diffChecksumChunkSize, true)
	assert.NoError(t, err)
	...
	err = applyDiffToRawImage(gotFilePath, diffReader, "snap20", "snap21", expansionUnitSize, rawChecksumChunkSize, diffChecksumChunkSize, true)
	assert.NoError(t, err)
...
func TestApplyDiffToRawImage_success_MissingRawImage(t *testing.T) {
	...
	// Act
	err = applyDiffToRawImage(rawImageFilePath, reader, "", "toSnap", 7, rawChecksumChunkSize, diffChecksumChunkSize, true)
...
func TestApplyDiffToRawImage_success_ExistentRawImage(t *testing.T) {
	...
	// Act
	err = applyDiffToRawImage(rawImageFilePath, reader, "fromSnap", "toSnap", 7, rawChecksumChunkSize, diffChecksumChunkSize, true)
...
func TestApplyDiffToRawImage_success_EmptyDataRecords(t *testing.T) {
	...
	// Act
	err = applyDiffToRawImage(rawImageFilePath, reader, "fromSnap", "toSnap", uint64(expansionUnitSize), 64*1024, 2*1024*1024, true)
...
func TestApplyDiffToRawImage_success_RawImageExpansion(t *testing.T) {
	...
	// Act
	err = applyDiffToRawImage(rawImageFilePath, reader, "fromSnap", "toSnap", 1*1024, rawChecksumChunkSize, diffChecksumChunkSize, true)
...
func TestApplyDiffToRawImage_success_LengthZero(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			// Act
			err = applyDiffToRawImage(rawImageFilePath, reader, "fromSnap", "toSnap", 10, rawChecksumChunkSize, diffChecksumChunkSize, true)
...
func TestApplyDiffToRawImage_error_InvalidHeader(t *testing.T) {
	...
	// Act
	err = applyDiffToRawImage(getRawImagePathForTest(t), reader, "", "toSnap", 10, rawChecksumChunkSize, diffChecksumChunkSize, true)
...
func TestApplyDiffToRawImage_error_ExpansionUnitSizeNonPositive(t *testing.T) {
	...
	err = applyDiffToRawImage(
		...
		rawChecksumChunkSize, diffChecksumChunkSize,
		false,
	)
...
func TestApplyDiffToRawImage_error_FromSnapNameMismatch(t *testing.T) {
	...
	// Act
	err = applyDiffToRawImage(getRawImagePathForTest(t), reader, "fromSnap2", "toSnap", 10, rawChecksumChunkSize, diffChecksumChunkSize, true)
...
func TestApplyDiffToRawImage_error_ToSnapNameMismatch(t *testing.T) {
	...
	// Act
	err = applyDiffToRawImage(getRawImagePathForTest(t), reader, "fromSnap", "toSnap2", 10, rawChecksumChunkSize, diffChecksumChunkSize, true)
